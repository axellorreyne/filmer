...
class FFooter extends Component 
{
  ...
  {
    return (
    <div className="ffs-4 rgb-2 text-center mt-auto ffooter mb-3">
        <p className="mb">All movie information is provided by <a href="https://www.themoviedb.org/">TMDB</a></p>
        <p className="mb-1">
